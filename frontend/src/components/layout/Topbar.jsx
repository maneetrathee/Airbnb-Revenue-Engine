      ...
      <div className="flex items-center gap-2 relative">
        ...
        <div className="relative">
          <button
            ...
            className="p-2 rounded-xl text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all relative"
          >
            <Bell size={18} />
            {hasNotifs && (
          ...
          {notifOpen && (
            <>
              ...
              <div className="absolute right-0 top-11 w-80 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 z-50 overflow-hidden">
                ...
                {hasNotifs ? (
                  <ul className="divide-y divide-gray-100 dark:divide-gray-800 max-h-72 overflow-y-auto">
                    {MOCK_NOTIFICATIONS.map((n) => (
                      <li key={n.id} className="px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-800/60">
